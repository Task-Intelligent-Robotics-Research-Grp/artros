...
#include <aist_msgs/msg/point_correspondence_array_array.hpp>
...
class MultiDetector : public rclcpp::Node
{
  private:
    ...
    using correses_set_t= aist_msgs::msg::PointCorrespondenceArrayArray;
			     ...
			     const std::string& camera_name)
{
  ...
  // Create point correspondences for this image.
    aist_msgs::msg::PointCorrespondenceArray	correspondences;
    ...
    {
	aist_msgs::msg::PointCorrespondence	correspondence;
