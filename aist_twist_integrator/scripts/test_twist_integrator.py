...
from aist_twist_integrator import TwistIntegratorClient
from aist_utility.compat   import *

######################################################################
#  class TestTwistIntegrator                                         #
######################################################################
class TestTwistIntegrator(TwistIntegratorClient):
    def __init__(self, server='twist_integrator'):
        TwistIntegratorClient.__init__(self, server)
...
if __name__ == '__main__':
    ...
    rospy.init_node('test_twist_integrator')

    client = TestTwistIntegrator('twist_integrator')
    client.run()
